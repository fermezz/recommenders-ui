...
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Recommenders.Capability.Navigate"] = $PS["Recommenders.Capability.Navigate"] || {};
  var exports = $PS["Recommenders.Capability.Navigate"];
  var Control_Monad_Trans_Class = $PS["Control.Monad.Trans.Class"];
...
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Recommenders.Data.Route"] = $PS["Recommenders.Data.Route"] || {};
  var exports = $PS["Recommenders.Data.Route"];
  var Data_Eq = $PS["Data.Eq"];
  var Data_Function = $PS["Data.Function"];
  var Data_Generic_Rep = $PS["Data.Generic.Rep"];
  var Data_Maybe = $PS["Data.Maybe"];
  ...
  var ByeWorld = (function () {
      function ByeWorld() {

      };
      ByeWorld.value = new ByeWorld();
      return ByeWorld;
  })();
  ...
  var run = function (p) {
      var $25 = Data_Function.flip(Routing_Duplex_Parser.runRouteParser)(p);
      return function ($26) {
          return (function (v) {
              if (v instanceof Routing_Duplex_Parser.Fail) {
                  return new Data_Maybe.Just(NotFound.value);
              };
              if (v instanceof Routing_Duplex_Parser.Success) {
                  return new Data_Maybe.Just(v.value1);
              };
              throw new Error("Failed pattern match at Recommenders.Data.Route (line 35, column 49 - line 37, column 28): " + [ v.constructor.name ]);
          })($25(Routing_Duplex_Parser.parsePath($26)));
      };
  };
  var parse = function (v) {
      return run(v.value1);
  ...
  var genericRoute = new Data_Generic_Rep.Generic(function (x) {
      ...
      if (x instanceof ByeWorld) {
          return new Data_Generic_Rep.Inr(new Data_Generic_Rep.Inl(Data_Generic_Rep.NoArguments.value));
      };
      if (x instanceof NotFound) {
          return new Data_Generic_Rep.Inr(new Data_Generic_Rep.Inr(Data_Generic_Rep.NoArguments.value));
      };
      throw new Error("Failed pattern match at Recommenders.Data.Route (line 18, column 1 - line 18, column 48): " + [ x.constructor.name ]);
  }, function (x) {
      if (x instanceof Data_Generic_Rep.Inl) {
          return HelloWorld.value;
      };
      if (x instanceof Data_Generic_Rep.Inr && x.value0 instanceof Data_Generic_Rep.Inl) {
          return ByeWorld.value;
      };
  ...
  var routeCodec = Routing_Duplex.root(Routing_Duplex_Generic.sum(genericRoute)(Routing_Duplex_Generic.gRouteSum(Routing_Duplex_Generic.gRouteConstructor(new Data_Symbol.IsSymbol(function () {
      ...
      HelloWorld: Routing_Duplex_Generic.noArgs,
      ByeWorld: Routing_Duplex_Generic_Syntax.gsep(Routing_Duplex_Generic_Syntax.gsepStringRoute(Routing_Duplex_Generic.gRouteNoArguments))("bye")(Routing_Duplex_Generic.noArgs),
      NotFound: Routing_Duplex_Generic_Syntax.gsep(Routing_Duplex_Generic_Syntax.gsepStringRoute(Routing_Duplex_Generic.gRouteNoArguments))("notfound")(Routing_Duplex_Generic.noArgs)
  }));    
  var eqRoute = new Data_Eq.Eq(function (x) {
      return function (y) {
          ...
          if (x instanceof ByeWorld && y instanceof ByeWorld) {
              return true;
          };
...
(function($PS) {
  ...
  var Effect_Class = $PS["Effect.Class"];
  var Recommenders_Capability_Navigate = $PS["Recommenders.Capability.Navigate"];
  var Recommenders_Data_Route = $PS["Recommenders.Data.Route"];
  var Routing_Duplex = $PS["Routing.Duplex"];
  var Routing_Hash = $PS["Routing.Hash"];
  var runAppM = function (v) {
      return v;
  };
  var monadEffectAppM = Effect_Aff.monadEffectAff;
  var monadAppM = Effect_Aff.monadAff;
  var navigateAppM = new Recommenders_Capability_Navigate.Navigate(function () {
      return monadAppM;
  }, (function () {
      var $2 = Effect_Class.liftEffect(monadEffectAppM);
      var $3 = Routing_Duplex.print(Recommenders_Data_Route.routeCodec);
      return function ($4) {
          return $2(Routing_Hash.setHash($3($4)));
      };
  })());
  var monadAffAppM = Effect_Aff_Class.monadAffAff;
...
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Recommenders.Component.ByeWorld"] = $PS["Recommenders.Component.ByeWorld"] || {};
  var exports = $PS["Recommenders.Component.ByeWorld"];
  var Halogen_Component = $PS["Halogen.Component"];
  var Halogen_HTML_Core = $PS["Halogen.HTML.Core"];
  var render = function (state) {
      return Halogen_HTML_Core.text(state.text);
  };
...
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Recommenders.Component.HelloWorld"] = $PS["Recommenders.Component.HelloWorld"] || {};
  var exports = $PS["Recommenders.Component.HelloWorld"];
  var Halogen_Component = $PS["Halogen.Component"];
  var Halogen_HTML_Core = $PS["Halogen.HTML.Core"];
  var render = function (state) {
      return Halogen_HTML_Core.text(state.text);
...
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Recommenders.Component.Router"] = $PS["Recommenders.Component.Router"] || {};
  var exports = $PS["Recommenders.Component.Router"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Monad_State_Class = $PS["Control.Monad.State.Class"];
  var Data_Either = $PS["Data.Either"];
  ...
  var Halogen_Query_HalogenM = $PS["Halogen.Query.HalogenM"];
  var Recommenders_Capability_Navigate = $PS["Recommenders.Capability.Navigate"];
  var Recommenders_Component_ByeWorld = $PS["Recommenders.Component.ByeWorld"];
  var Recommenders_Component_HelloWorld = $PS["Recommenders.Component.HelloWorld"];
  var Recommenders_Data_Route = $PS["Recommenders.Data.Route"];
  var Routing_Duplex = $PS["Routing.Duplex"];
  var Routing_Hash = $PS["Routing.Hash"];                
      ...
      return function (dictNavigate) {
          var render = function (v) {
              if (v.route instanceof Data_Maybe.Just) {
                  if (v.route.value0 instanceof Recommenders_Data_Route.HelloWorld) {
                      return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                          return "helloworld";
                      }))(Data_Ord.ordUnit)(Data_Symbol.SProxy.value)(Data_Unit.unit)(Recommenders_Component_HelloWorld.component)({})(Data_Void.absurd);
                  };
                  if (v.route.value0 instanceof Recommenders_Data_Route.ByeWorld) {
                      return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                          return "byeworld";
                      }))(Data_Ord.ordUnit)(Data_Symbol.SProxy.value)(Data_Unit.unit)(Recommenders_Component_ByeWorld.component)({})(Data_Void.absurd);
                  };
                  if (v.route.value0 instanceof Recommenders_Data_Route.NotFound) {
                      return Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text("Whoops! Page not found") ]);
                  };
                  throw new Error("Failed pattern match at Recommenders.Component.Router (line 66, column 15 - line 72, column 53): " + [ v.route.value0.constructor.name ]);
              };
              if (v.route instanceof Data_Maybe.Nothing) {
                  return Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text("Whoops! Page not found") ]);
              };
              throw new Error("Failed pattern match at Recommenders.Component.Router (line 65, column 22 - line 74, column 51): " + [ v.route.constructor.name ]);
          };
          var handleQuery = function (v) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  $14.route = new Data_Maybe.Just(v.value0);
                  return $14;
              }))(function () {
          ...
          var handleAction = function (v) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor.map(Halogen_Query_HalogenM.functorHalogenM)((function () {
                  var $20 = Routing_Duplex.parse(Recommenders_Data_Route.routeCodec);
                  return function ($21) {
                      return Data_Either.hush($20($21));
                  };
                  ...
                  return Recommenders_Capability_Navigate.navigate(Recommenders_Capability_Navigate.navigateHalogenM(dictNavigate))(Data_Maybe.fromMaybe(Recommenders_Data_Route.HelloWorld.value)(initialRoute));
              });
          };
...
(function($PS) {
  ...
  var Recommenders_Component_Router = $PS["Recommenders.Component.Router"];
  var Recommenders_Data_Route = $PS["Recommenders.Data.Route"];
  var Routing_Hash = $PS["Routing.Hash"];                
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (body) {
      var rootComponent = Halogen_Component.hoist(Halogen_HTML_Core.bifunctorHTML)(Effect_Aff.functorAff)(AppM.runAppM)(Recommenders_Component_Router.component(AppM.monadAffAppM)(AppM.navigateAppM));
      return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_VDom_Driver.runUI(rootComponent)({})(body))(function (halogenIO) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Data_Functor["void"](Effect_Aff.functorAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Routing_Hash.matchesWith(Data_Foldable.foldableMaybe)(Recommenders_Data_Route.parse(Recommenders_Data_Route.routeCodec))(function (old) {
              return function ($$new) {
                  return Control_Applicative.when(Effect.applicativeEffect)(Data_Eq.notEq(Data_Maybe.eqMaybe(Recommenders_Data_Route.eqRoute))(old)(new Data_Maybe.Just($$new)))(Effect_Aff.launchAff_(halogenIO.query(Halogen_Query.tell(Recommenders_Component_Router.Navigate.create($$new)))));
              };
          }))))(function () {
